...
@section('title', 'Sửa Hợp đồng thuê đất')
@section('page_title', 'Sửa Hợp đồng thuê đất')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Sửa Hợp đồng thuê đất</h3>
                ...
                <form action="{{ route('admin.land-rental.contracts.update', $landRentalContract->id) }}" method="POST"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('contract_number', $landRentalContract->contract_number) }}" required>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file"
                                                class="form-control-file @error('contract_file') is-invalid @enderror"
                                                id="contract_file" name="contract_file"
                                                accept=".pdf,.doc,.docx,.jpg,.jpeg,.png">
                                            <small class="form-text text-muted">Chỉ chấp nhận file PDF, DOC, DOCX, JPG,
                                                JPEG, PNG (tối đa 10MB)</small>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control @error('rental_decision') is-invalid @enderror"
                                        id="rental_decision" name="rental_decision"
                                        value="{{ old('rental_decision', $landRentalContract->rental_decision) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file"
                                        class="form-control-file @error('rental_decision_file') is-invalid @enderror"
                                        id="rental_decision_file" name="rental_decision_file"
                                        accept=".pdf,.doc,.docx,.jpg,.jpeg,.png">
                                    <small class="form-text text-muted">Chỉ chấp nhận file PDF, DOC, DOCX, JPG, JPEG, PNG
                                        (tối đa 10MB)</small>
                                        ...
                                        <div class="mt-2">
                                            <a href="{{ asset('storage/' . str_replace('public/', '', $landRentalContract->rental_decision_file_path)) }}"
                                                ...
                                                @if ($landRentalContract->rental_decision_file_name)
                                                    ({{ $landRentalContract->rental_decision_file_name }})
                                                @endif
                                            </a>
                                        </div>
                                    @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('rental_zone') is-invalid @enderror"
                                        id="rental_zone" name="rental_zone"
                                        value="{{ old('rental_zone', $landRentalContract->rental_zone) }}">
                                    @error('rental_zone')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control @error('rental_location') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('export_tax') is-invalid @enderror"
                                        id="export_tax" name="export_tax"
                                        value="{{ old('export_tax', $landRentalContract->export_tax) }}" step="0.0001"
                                        min="0" max="1">
                                    @error('export_tax')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    ...
                                    <div class="row">
                                        <div class="col-8">
                                            ...
                                            <input type="number" step="0.000001"
                                                class="form-control @error('area_value') is-invalid @enderror"
                                                id="area_value" name="area_value"
                                                value="{{ old('area_value', $landRentalContract->area['value'] ?? '') }}"
                                        ...
                                        <div class="col-4">
                                            ...
                                            <select class="form-control @error('area_unit') is-invalid @enderror"
                                                id="area_unit" name="area_unit">
                                                <option value="m2"
                                                    {{ old('area_unit', $landRentalContract->area['unit'] ?? 'm2') == 'm2' ? 'selected' : '' }}>
                                                    m²</option>
                                                <option value="ha"
                                                    {{ old('area_unit', $landRentalContract->area['unit'] ?? '') == 'ha' ? 'selected' : '' }}>
                                                    hecta</option>
                                                <option value="km2"
                                                    {{ old('area_unit', $landRentalContract->area['unit'] ?? '') == 'km2' ? 'selected' : '' }}>
                                                    km²</option>
                                            </select>
                                            @error('area_unit')
                                                <span class="invalid-feedback">{{ $message }}</span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label for="rental_start_date">Ngày bắt đầu <span
                                                    class="text-danger">*</span></label>
                                            <input type="date"
                                                class="form-control @error('rental_start_date') is-invalid @enderror"
                                                id="rental_start_date" name="rental_start_date"
                                                value="{{ old('rental_start_date', $landRentalContract->rental_period['start_date'] ?? '') }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('rental_end_date', $landRentalContract->rental_period['end_date'] ?? '') }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" step="0.1"
                                                class="form-control @error('rental_years') is-invalid @enderror"
                                                id="rental_years" name="rental_years"
                                                value="{{ old('rental_years', $landRentalContract->rental_period['years'] ?? '') }}"
                                                placeholder="Số năm">
                                            @error('rental_years')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes" rows="4">{{ old('notes', $landRentalContract->notes) }}</textarea>
                            @error('notes')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
