...
@section('title', 'Quản lý Cổ tức - Chi tiết Lần trả')
@section('page_title', 'Quản lý Cổ tức - Chi tiết Lần trả')

@section('content')
<div class="row mb-3">
    <div class="col-12">
        <a href="{{ route('admin.securities.dividend-record.index') }}" class="btn btn-secondary">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Chi tiết lần trả cổ tức - {{ $paymentDateFormatted }}</h3>
...
$(document).ready(function() {
    var table = $('#dividend-detail-table').DataTable({
        ...
        responsive: true,
        ajax: {
            url: "{{ route('admin.securities.dividend-record.detail', ['paymentDate' => $paymentDate]) }}",
            type: 'GET'
        },
        columns: [
