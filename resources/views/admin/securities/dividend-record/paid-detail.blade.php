...
@section('title', 'Quản lý Cổ tức - Chi tiết Trả Cổ tức')
@section('page_title', 'Quản lý Cổ tức - Chi tiết Trả Cổ tức')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Danh sách cổ đông được trả - Ngày {{ $transferDateFormatted }}</h3>
                <div class="card-tools">
                    <a href="{{ route('admin.securities.dividend-record.paid') }}" class="btn btn-sm btn-secondary" title="Quay lại">
...
$(document).ready(function() {
    var table = $('#dividend-detail-table').DataTable({
        ...
        ajax: {
            url: "{{ route('admin.securities.dividend-record.paid.detail', ['transferDate' => $transferDate]) }}",
            type: 'GET'
        },
        columns: [
