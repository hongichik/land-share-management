...
@section('title', 'Quản lý Cổ tức - Đã trả (Chưa lưu ký)')
@section('page_title', 'Quản lý Cổ tức - Đã trả (Chưa lưu ký)')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Danh sách cổ tức - Đã trả (Chưa lưu ký)</h3>
            ...
            <div class="card-body">
                <table id="paid-not-deposited-table" class="table table-striped table-hover">
                    <thead>
                        <tr>
...
$(document).ready(function() {
    $('#paid-not-deposited-table').DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
        ajax: {
            url: "{{ route('admin.securities.dividend-record.paid-not-deposited') }}",
            type: 'GET'
        },
        columns: [
